							...
							<ul class="navbar_menu">
								<li style="position: relative;">
									<form method="get" action="{{url('search')}}">
										<!--<i class="fa fa-search" style="position:absolute;color:white;cursor:pointer;border-right:none;font-size:16px;"></i>-->
                     <input type="submit" value="" class="btn-flat btn" style="background:#2d958b;width: 24px;height: 100%;margin-top: 0px;position: absolute;">
										<input type="text" name="query" class="form-control searchInput" style="color: darkcyan;font-family: Calibri , arial;font-size: 15px ; display: inline; width: 200px;text-align: right;padding: 0 5px 0 40px" placeholder="... بحث">
